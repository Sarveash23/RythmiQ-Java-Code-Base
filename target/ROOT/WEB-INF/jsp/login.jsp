<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%-- Document : Login Created on : Mar 19, 2024, 12:59:43 PM Author : Sarveashwaran --%>
            ...
            <body>
                <div class="h-screen flex pt-0 md:pt-2 justify-center items-center bg-cover no-repeat">
                    <form method="POST" modelAttribute="login" action="/login"
                        ...
                        <img src="<%=request.getContextPath()%>/images/logo.jpg" class="w-[200px] h-[100px]" alt=""
                            srcset="" />
                        <h1 class="text-center text-2xl md:text-4xl">Welcome To RhythmiQ <br> <span
                                class="font-cursive italic">Learn
                                Music Your Own
                                Way</span>
                        </h1>
                        <div class="flex flex-col justify-center items-center space-y-6">
                            <div class="flex flex-col justify-start">
                                ...
                                <input
                                    ...
                                    required="required" value="${login.username}" />
                                <span style="color: red; ">
                                    <c:out value="${errorUsername}"></c:out>
                                </span>
                            </div>
                            <div class="flex flex-col justify-start">
                        ...
                        <h1>Don't Have an Account ? <a class="text-[#0059D6] underline"
                                href="<%=request.getContextPath()%>/registration">Click Here</a></h1>
                    </form>
                </div>
            </body>
